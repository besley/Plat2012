...
(function ($) {
  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function init() {
      ...
      $viewport = $("<div class='slick-viewport' style='width:100%;overflow:auto;outline:1px;outline-color:#897048;outline-style:groove;outline-width:2px;outline-offset: 5px;position:relative;;'>").appendTo($container);
