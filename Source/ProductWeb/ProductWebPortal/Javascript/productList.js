;(function (pwpProductList, $, undefined) {
    ...
    pwpProductList.init = function() {
        ...
        if (productTypeId == undefined) {
            ...
            doHttpClientGet("/ProductSys.WebAPI/api/Product/Get" + "?ProductType=" + productTypeId, function (dataJson) {
                dsProduct = dataJson;
                InitializeSlickGridData();
            });
        }
    ...
    pwpProductList.onSearchClick = function () {
