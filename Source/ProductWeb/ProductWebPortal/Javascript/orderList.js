;(function (pwpOrderList, $, undefined) {
    ...
    //button click event
    pwpOrderList.onAddClick = function () {
        var url = "/ProductWebPortal/Order/Create";
    ...
    pwpOrderList.onEditClick = function () {
        var item = getSelectedDataItem();
        var id = item.ID;
        var url = "/ProductWebPortal/Order/Detail/" + id;
    ...
    pwpOrderList.onDeleteClick = function () {
        var delData = [];
    ...
    pwpOrderList.onSaveClick = function () {
...
})(window.pwpOrderList = window.pwpOrderList || {}, jQuery)