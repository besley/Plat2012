...
define([
    ...
    Function.prototype.inherit = function (ParentClass, noParent) {
        ...
        if (ParentClass != null && (ParentClass.constructor === Function || typeof (ParentClass.constructor) == 'function')) {
    ...
    //#region Function.prototype.multiInherit
    //appends prototypes, rewrites same name methods, uses jQuery
    Function.prototype.multiInherit = function (arr) {

        if ('object' !== typeof (arr))
            throw ('.multiInherit expets argument to be array');

        //#region recInherit
        var recInherit = function (arr, key) {

            if (key >= arr.length || key < 1)
                return null;

            if ('function' !== typeof (arr[key - 1]) || 'function' !== typeof (arr[key]))
                throw ('.multiInherit.recInherit expects array elements to be functions');
    ...
    //#region Array.prototype.indexOf
    ...
    //#region String.prototype.startsWith
