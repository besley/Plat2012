...
(function($) {
    ...
    function SlickGrid(container,data,columns,options) {
        ...
        function getMaxSupportedCssHeight() {
            if (Slick._maxSupportedCssHeight)
                return Slick._maxSupportedCssHeight;
            ...
            div.remove();
            Slick._maxSupportedCssHeight = supportedHeight;
        ...
        function styleColumnWidth(index,width,styleCells) {
            ...
            if (styleCells) {
                findCssRuleForCell(index).style.width = Math.max(0, width - cellWidthDiff) + "px";
            }
        }
        ...
        function updateRowPositions() {
            for (var row in rowsCache) {
				var newTop = (row*options.rowHeight-offset);
                rowsCache[row].style.top = (newTop && newTop > 0 ? newTop : 0) + "px";
            }
        }
