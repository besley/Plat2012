...
function SubShowClass(ID, eventType, defaultID, openClassName, closeClassName)
{
    ...
    if (ID != "none") {
        if (this.parentObj.attachEvent) {
            ...
            this.parentObj.bind("mouseover", mouseInFunc, false)
        }
    };
    ...
    if (ID != "none") {
        if (this.parentObj.attachEvent) {
            ...
            this.parentObj.bind("mouseout", mouseOutFunc, false)
        }
    };
    ...
    this.addLabel = function (labelID, contID, parentBg, springEvent, blurEvent) {
        ...
        if (labelID != "none") {
            if (SubShowClass.$(labelID).attachEvent) {
                ...
                SubShowClass.$(labelID).bind(this.eventType, tempFunc, false)
            }
        };
        ...
        if (TempID == this.defaultID) {
            ...
            if (SubShowClass.$(contID)) {
                ...
                SubShowClass.$(contID).css({ 'display': 'none' });
            };
        ...
        if (SubShowClass.$(contID)) {
            if (SubShowClass.$(contID).attachEvent) {
                ...
                SubShowClass.$(contID).bind("mouseover", mouseInFunc, false)
            };
            ...
            if (SubShowClass.$(contID).attachEvent) {
                ...
                SubShowClass.$(contID).bind("mouseout", mouseOutFunc, false)
            }
        }
    };
